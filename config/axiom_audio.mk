...
ALARM_PATH := vendor/axiom/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/axiom/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/axiom/prebuilt/common/media/audio/ringtones
