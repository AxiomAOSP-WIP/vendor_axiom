...
#tmp
AXIOM_RELEASE_TYPE := OFFICIAL-RC1

#TODO
ifneq ($(AXIOM_VERSION_APPEND_TIME_OF_DAY),true)
    AXIOM_BUILD_DATE := $(shell date -u +%Y%m%d_%H%M)
else
...
RO_AXIOM_VERSION := $(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)
